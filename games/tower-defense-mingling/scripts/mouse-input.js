...
MouseInput.prototype.pan = function(screenPoint) {
    ...
    var distance = this.entity.camera.nearClip;
    ...
    this.entity.setLocalPosition(worldDiff);    
};
...
MouseInput.prototype.onMouseMove = function (event) {    
    ...
    if (this.lookButtonDown) {
        // this.orbitCamera.pitch -= event.dy;
        // this.orbitCamera.yaw -= event.dx;
...
MouseInput.prototype.onMouseWheel = function (event) {
    this.entity.camera.fov -= event.wheel /** this.distanceSensitivity * (this.orbitCamera.distance * 0.1)*/;
