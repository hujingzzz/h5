...
function initMobileHandle(){
    ...
    $(window).scroll(function () {
        ...
        var scrollBottom = screen.height + $(window).scrollTop();
        var categoryHeight = $(".lStd1276e_IhuA3g3FIs.ADMPJVcFvhX6udYDGs_x").children().last().height();
        var gameheight = $(".lStd1276e_IhuA3g3FIs.ADMPJVcFvhX6udYDGs_x").height() - categoryHeight;
         
    
        if(scrollBottom >= gameheight){
